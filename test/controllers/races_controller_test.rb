...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { name: @race.name, start_datetime: @race.start_datetime } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { name: @race.name, start_datetime: @race.start_datetime } }
